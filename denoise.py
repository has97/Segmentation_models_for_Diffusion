############################# This code is directly used from Lucid Drains github repo for Gaussian Diffusion process ############
import math
...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        self.transform = T.Compose([
            T.Resize(diffusion_model.image_size),
            T.ToTensor()
        ])
        ...
        self.mnist_trainset = datasets.FashionMNIST(root='./data_fashion', train=True, download=True,transform=self.transform)
        self.mnist_trainset1, self.mnist_trainset2 = zip(*self.mnist_trainset)
        dl = DataLoader(self.mnist_trainset1, batch_size = train_batch_size, shuffle = True, pin_memory = True, num_workers = cpu_count())
    ...
    def save(self, milestone):
        ...
        torch.save(data, str(self.results_folder / f'model-{milestone%10}.pt'))
